...
hide($content['comment_form']['author']['homepage']); 
hide($content['comment_form']['author']['description']); 
$comments = render($content['comments']);
$comment_form = render($content['comment_form']);
?>
<?php // echo_array($content['comment_form']); ?>
<div id="comments" class="<?php print $classes; ?>"<?php print $attributes; ?>>
	
	<div class="posted_comments">
	<p class="title">
		<?php print $node -> comment_count; ?> Responses to <?php print $node -> title; ?>
	</p>
	  <?php print $comments; ?>
	</div>
  <?php if ($comment_form): ?>
