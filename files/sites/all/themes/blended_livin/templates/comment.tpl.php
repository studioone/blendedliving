...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
	...
	<div class="c_content">
		<div class="c_head"><span class="c_name"><?php print $author; ?></span> Says</div>
		<div class="c_meta"><?php print $preprocessed_date;?></div>
		<div class="c_text"><?php print render($content['comment_body']);?></div>
	</div>
